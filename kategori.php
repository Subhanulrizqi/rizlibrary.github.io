        ...
        <div class="col-sm-10">
            <div class="card">
                <div class="card-header">
                    <strong>Form</strong> Kategori Buku
                </div>
                <div class="card-body card-block">
                    <form action="proses_kategori.php" method="post" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="" class=" form-control-label">Kategori Buku</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="kategori" name="kategori" placeholder="" class="form-control" required></div>
                        </div>
